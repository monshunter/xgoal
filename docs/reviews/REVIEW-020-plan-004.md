...
- Passive Probe 与 Active Contract Probe 分离；只有后者允许 Provider Transport，避免普通诊断产生模型调用。
...
- Claude Reviewer、完整 Reconcile/Gate、Daemon/API 与最终报告仍留在 M4–M6，没有扩大当前 Plan。
