...
func TestAllSpecifiedEndpointsAreRouted(t *testing.T) {
	tests := []struct {
		...
		{http.MethodGet, "/v1/goals?limit=1&state=DRAFT&after=g0", "goal.list", false},
		{http.MethodGet, "/v1/doctor", "doctor", false},
		{http.MethodGet, "/v1/identifiers?kind=goal", "identifiers", false},
		{http.MethodGet, "/v1/work-items/w1", "work.get", false},
		{http.MethodGet, "/v1/gates/gate1", "gate.get", false},
		{http.MethodPost, "/v1/doctor/active-probes", "doctor.active-probe", true},
		{http.MethodGet, "/v1/goals/g1/invocations", "goal.invocations", false},
		{http.MethodGet, "/v1/invocations/invoke1/context", "invocation.context", false},
		{http.MethodGet, "/v1/invocations/invoke1/logs", "invocation.logs", false},
		...
		{http.MethodPost, "/v1/gates/gate1/resume", "gate.resume", true},
